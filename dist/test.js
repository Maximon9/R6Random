...
import { Renderer2D } from "./utils/animation/renderer.js";
...
let num = 0.2;
new AnimationCurve(["achor", 0, 0], ["control", 1 / 6 + num, 1 / 6 - num], ["control", 1 / 3 + num, 1 / 3 - num], ["achor", 0.5, 0.5], ["control", 2 / 3 - num, 2 / 3 + num], ["control", 5 / 6 - num, 5 / 6 + num], ["achor", 1, 1]).fetchTime(0.5);
const animator = new Animator({
    condition: 60,
    animate: () => { },
    animationType: new AnimationCurve(["achor", 0, 0], ["control", 1 / 6 + num, 1 / 6 - num], ["control", 1 / 3 + num, 1 / 3 - num], ["achor", 0.5, 0.5], ["control", 2 / 3 - num, 2 / 3 + num], ["control", 5 / 6 - num, 5 / 6 + num], ["achor", 1, 1]),
});
